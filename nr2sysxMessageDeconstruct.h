...
#ifndef _NR2SYSXMESSAGEDECONSTRUCT_H_
#define _NR2SYSXMESSAGEDECONSTRUCT_H_

#include <basicfb.h>
#include <forte_bool.h>
#include <forte_string.h>

class FORTE_nr2sysxMessageDeconstruct: public CBasicFB{
  DECLARE_FIRMWARE_FB(FORTE_nr2sysxMessageDeconstruct)
...
public:
  FORTE_nr2sysxMessageDeconstruct(CStringDictionary::TStringId pa_nInstanceNameId, CResource *pa_poSrcRes) : 
       CBasicFB(pa_poSrcRes, &scm_stFBInterfaceSpec, pa_nInstanceNameId,
              0, m_anFBConnData, m_anFBVarsData){
  };

  virtual ~FORTE_nr2sysxMessageDeconstruct(){};

...
#ifndef _SYSX2NRMESSAGECONSTRUCT_H_
#define _SYSX2NRMESSAGECONSTRUCT_H_

#include <basicfb.h>
#include <forte_bool.h>
#include <forte_string.h>

class FORTE_sysx2nrMessageConstruct: public CBasicFB{
  DECLARE_FIRMWARE_FB(FORTE_sysx2nrMessageConstruct)
...
public:
  FORTE_sysx2nrMessageConstruct(CStringDictionary::TStringId pa_nInstanceNameId, CResource *pa_poSrcRes) : 
       CBasicFB(pa_poSrcRes, &scm_stFBInterfaceSpec, pa_nInstanceNameId,
              0, m_anFBConnData, m_anFBVarsData){
  };

  virtual ~FORTE_sysx2nrMessageConstruct(){};
